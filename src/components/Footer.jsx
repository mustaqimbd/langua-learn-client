            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        ...
                        <p className='w-[250px] text-gray-500'>Learn languages from around the world.Discover new cultures and perspectives.</p>
                    </div>
                    <div>
                        <h2 className="text-center mb-6 text-sm font-semibold uppercase dark:text-white">Follow us</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold  uppercase dark:text-white">Contact Info</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white">Address</h2>
                        <ul className="text-gray-600 dark:text-gray-400 font-medium">
                            <li className="mb-4">
                                New York,
                            </li>
                ...
                <div className='text-center'>
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 LanguaLearn. All Rights Reserved.
                    </span>
